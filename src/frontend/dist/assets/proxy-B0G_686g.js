...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "footer",
    {
      ...
      "data-ocid": "footer",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-0.5 bg-gradient-to-r from-transparent via-accent/60 to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "inline-flex flex-col mb-5 group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tracking-[0.25em]", children: "MASTER" }),
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-gold tracking-[0.15em]", children: "DEEPAK" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-semibold tracking-[0.22em] uppercase text-accent/70 leading-tight mt-0.5", children: "Hair Expert" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "India's premier hair education brand. Cut, Color & Chemical — transforming hair artistry across India."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "badge-gold mb-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  style: { ...footerIconBg, color: "oklch(var(--footer-muted))" },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiYoutube, { className: "w-4 h-4" })
                }
              )
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[10px] font-semibold uppercase tracking-[0.2em] text-accent mb-5", children: "Our Locations" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: LOCATIONS.map(({ city, address, phone }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 mb-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3.5 h-3.5 text-accent/70 mt-0.5 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "address",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-3.5 h-3.5 text-accent/70 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[10px] font-semibold uppercase tracking-[0.2em] text-accent mb-5", children: "Quick Links" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: QUICK_LINKS.map(({ label, href }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: href.startsWith("/") && !href.startsWith("/#") ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: href,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[10px] font-semibold uppercase tracking-[0.2em] text-accent mb-5", children: "Get Started" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-5 leading-relaxed", style: footerTextMuted, children: "Ready for a transformation? Book your appointment with Master Deepak today." }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SiYoutube, { className: "w-3.5 h-3.5 text-destructive" }),
                  "Watch on YouTube"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs leading-relaxed", style: footerTextMuted, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-medium", children: "Master Scissor Academy" }),
                  " ",
                  "— Professional hair training programs with franchise opportunities across India."
                ] })
              }
            )
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t", style: footerBorder, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2", children: [
...
function Header() {
  ...
  const prevPath = reactExports.useRef(location.pathname);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      className: `fixed top-0 left-0 right-0 z-50 transition-smooth ${scrolled ? "bg-card/97 backdrop-blur-lg shadow-elevated" : "bg-card/95 backdrop-blur-md"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(90deg, transparent 0%, oklch(0.65 0.15 68) 30%, oklch(0.72 0.14 75) 50%, oklch(0.65 0.15 68) 70%, transparent 100%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-14 sm:h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: "/",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-black text-base sm:text-lg leading-tight text-foreground group-hover:text-accent transition-smooth", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tracking-[0.25em]", children: "MASTER" }),
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-gold tracking-[0.15em]", children: "DEEPAK" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold tracking-[0.22em] uppercase text-accent/70 leading-tight", children: "Hair Expert" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 sm:gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SiYoutube, { className: "w-3 h-3 sm:w-3.5 sm:h-3.5 text-destructive" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden xs:inline", children: "YouTube" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/booking", "data-ocid": "header-book-cta", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "nav",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-2 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex items-center justify-center flex-wrap gap-x-1 sm:gap-x-0", children: NAV_LINKS.map((link) => {
